            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="space-y-12 max-w-5xl mx-auto mb-24">
                    {events.map((event, index) => (
                        <div key={index} className="bg-[#1a1a1a] rounded-3xl border border-white/10 overflow-hidden flex flex-col md:flex-row group hover:border-brand/50 transition-colors">
                            <div
                            ...
                            <div className="p-8 md:w-3/5 flex flex-col justify-between">
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-white/10">
                                    ...
                                    <button className="w-full sm:w-auto px-8 py-3 bg-brand hover:bg-brand/90 text-black font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 uppercase tracking-wide text-sm">
                                        S'inscrire
                                    </button>
                                </div>
                            </div>
                ...
                <div className="max-w-5xl mx-auto bg-gradient-to-r from-[#1a1a1a] to-[#222] p-8 md:p-12 rounded-3xl border border-white/5 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div>
                            ...
                            <Link to="/contact" className="inline-flex items-center gap-2 text-brand hover:text-white transition-colors uppercase tracking-wider text-sm font-semibold group cursor-pointer border-b border-brand pb-1">
