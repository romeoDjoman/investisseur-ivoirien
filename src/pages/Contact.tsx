            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="w-full lg:w-1/3 flex flex-col gap-10">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="#" className="text-white font-medium hover:text-brand transition-colors block">
                        ...
                        {/* Social Proof Mini */}
                        <div className="bg-brand/5 rounded-3xl p-8 border border-brand/10 text-center">
                    ...
                    {/* Formulaire */}
                    <div className="w-full lg:w-2/3 bg-[#1a1a1a] rounded-3xl p-8 md:p-12 border border-white/5">
                        <form className="flex flex-col gap-6 w-full">
                            ...
                            <div className="pt-4">
                                <button type="button" className="w-full md:w-auto px-10 py-4 bg-brand hover:bg-brand/90 text-black font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 uppercase tracking-wide text-sm shadow-[0_0_20px_rgba(249,168,37,0.3)]">
                                    Envoyer mon message
                                </button>
